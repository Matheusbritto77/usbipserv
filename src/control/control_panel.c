...
void control_panel_run(const char *server_ip) {
    ...
    printf("\033[H\033[J");
    printf("┌────────────────────────────────────────────────────────────────────────────┐\n");
    printf("│      USB Redirector Technician Edition - Evaluation Version (C / usbredir) │\n");
    printf("├────────────────────────────────────────────────────────────────────────────┤\n");
    ...
    if (sock != INVALID_SOCKET) {
        ...
        if (net_recv_all(sock, &resp_hdr, sizeof(resp_hdr)) == 0 && usbredir_header_verify(&resp_hdr)) {
            ...
            printf("│ │  \033[1;36m💻 Established connection with customer at 192.168.1.40                \033[0m│ │\n");
            printf("│ │     └── \033[1;32m🔌 iPhone - USB Imaging Device                                  \033[0m│ │\n");
