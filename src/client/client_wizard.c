...
static void print_step_ui(usb_service_status_t step, int progress,
  ...
  if (step >= USB_STATUS_WAITING_TECH) {
    printf("│  \033[1;32m2  Waiting for technician to start servicing your "
           "device\033[0m                 │\n");
    printf("│     Technician is getting ready to service your device...        "
           "          │\n");
  } else {
    printf("│  \033[90m2  Waiting for technician to start servicing your "
           "device\033[0m                 │\n");
    printf("│     Technician is getting ready to service your device.          "
           "          │\n");
  }
  ...
  if (step == USB_STATUS_FINISHED) {
    printf("│  \033[1;32m4  Servicing of your device has been finished\033[0m  "
           "                          │\n");
    printf("│     \033[1;33mPlease unplug the device from USB port and click "
           "Finish to close.\033[0m     │\n");
  } else {
...
void client_wizard_run(const char *server_ip) {
  ...
  if (sock != INVALID_SOCKET) {
    ...
    usbredir_header_init(&hdr, USBREDIR_CMD_REGISTER_CLIENT,
                         sizeof(usbredir_packet_register_t));
